...
import net.cccstudio.renewedthis.procedures.BedrockshovelBlockDestroyedWithToolProcedure;
...
public class BedrockshovelItem extends ShovelItem {
	...
	public boolean mineBlock(ItemStack itemstack, Level world, BlockState blockstate, BlockPos pos, LivingEntity entity) {
		...
		BedrockshovelBlockDestroyedWithToolProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
		return retval;
	}
}
